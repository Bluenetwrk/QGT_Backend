...
const Archived= require("../Schema/QgtArchieveBuyerSchema")
const DeletedBlog= require("../Schema/QgtDeletedBlogsSchema")
...
const BlogModel=require("../Schema/QgtPostBlogsSchema")
